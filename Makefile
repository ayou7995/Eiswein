...
help:
	...
	@echo "  make backfill DAYS=1260   Extend price history (max 1260 = 5y); restart picks up new window"
	@echo "  make update               git pull + rebuild + restart (run this when a new version drops)"
